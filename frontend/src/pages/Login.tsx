...
const Login: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main Container */}
      <div className="w-full max-w-[420px] z-10 flex flex-col items-center my-auto">
        {/* Top Header Section with Frosted Glass Container for High Visibility */}
        <div className="text-center mb-2 sm:mb-2.5 bg-white/95 backdrop-blur-md px-3.5 sm:px-6 py-2 sm:py-2.5 rounded-2xl shadow-lg shadow-slate-900/10 border border-white/80 w-full flex flex-col items-center transition-all">
          {/* Company Name */}
          <h1 className="text-sm sm:text-base md:text-lg font-black text-slate-950 tracking-tight uppercase leading-tight">
            RWANDA PLASTIC INDUSTRY
          </h1>

          {/* System Name */}
          <p className="text-[11px] sm:text-xs md:text-sm font-bold text-slate-800 mt-0.5 leading-tight">
            Employee Meal Management System
          </p>

          {/* Tagline */}
          <p className="text-[9px] sm:text-[10px] md:text-[11px] font-semibold text-blue-700 tracking-wide mt-0.5 leading-tight">
          ...
          <div className="mt-1.5 sm:mt-2 w-9 h-9 sm:w-11 sm:h-11 bg-gradient-to-b from-blue-500 to-blue-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-md shadow-blue-500/25 border border-white/40 ring-2 ring-blue-500/15 transition-transform duration-200 hover:scale-105">
            <UtensilsCrossed className="w-4.5 h-4.5 sm:w-6 sm:h-6 text-white drop-shadow-xs" />
          </div>
        </div>

        {/* Centered White Login Card */}
        <div className="w-full bg-white rounded-2xl sm:rounded-3xl shadow-xl shadow-slate-900/10 border border-slate-200/80 p-3.5 sm:py-4 sm:px-6 transition-all">
          {/* Meal Emblem Graphic */}
          <div className="flex flex-col items-center justify-center mb-2 sm:mb-2.5">
            <div className="relative w-10 h-10 sm:w-13 sm:h-13 flex items-center justify-center">
              ...
              <div className="w-7 h-7 sm:w-8.5 sm:h-8.5 rounded-full bg-gradient-to-b from-slate-50 to-blue-50/60 border border-slate-200 flex items-center justify-center shadow-inner">
                <Utensils className="w-3.5 h-3.5 sm:w-4.5 sm:h-4.5 text-blue-600" />
              </div>
            </div>

            {/* Welcome Back & Subtitle */}
            <h2 className="text-sm sm:text-base md:text-lg font-black text-slate-900 mt-1 tracking-tight leading-tight">
              Welcome Back
            </h2>
          ...
          {setupNeeded && (
            <div className="mb-2 p-2 bg-emerald-50 border border-emerald-200 rounded-xl flex items-start gap-1.5">
              ...
              <div>
                ...
                <Link
                  to="/setup-admin"
                  className="text-[9px] sm:text-[10px] font-bold text-emerald-700 hover:text-emerald-900 underline"
                >
          ...
          {/* Error Message */}
          {error && (
            <div className="mb-2 bg-rose-50 border border-rose-200 rounded-xl p-2 flex items-start gap-1.5 animate-shake">
              <AlertCircle className="w-3.5 h-3.5 text-rose-600 shrink-0 mt-0.5" />
              <p className="text-[10px] sm:text-[11px] font-medium text-rose-700 leading-tight">
                {error}
              </p>
            </div>
          )}
          ...
          <form className="space-y-2 sm:space-y-2.5" onSubmit={handleSubmit(onSubmit)}>
            {/* Email or Username */}
            <div>
              <label className="block text-[10px] sm:text-[11px] font-bold text-slate-700 mb-0.5 sm:mb-1">
                Email or Username
              </label>
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-50/50 hover:bg-white focus:bg-white border border-slate-200 hover:border-slate-300 rounded-lg px-2.5 py-1.5 sm:py-2 text-xs sm:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 pl-8 sm:pl-9 transition-all shadow-xs"
                  placeholder="Enter your email or username"
                  autoComplete="username"
                />
                <User className="w-3.5 h-3.5 text-slate-400 absolute left-2.5 sm:left-3 top-1/2 -translate-y-1/2" />
              </div>
              {errors.usernameOrEmail && (
                <p className="text-[9px] sm:text-[10px] text-rose-500 font-medium mt-0.5">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-50/50 hover:bg-white focus:bg-white border border-slate-200 hover:border-slate-300 rounded-lg px-2.5 py-1.5 sm:py-2 text-xs sm:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 pl-8 sm:pl-9 pr-8 sm:pr-9 transition-all shadow-xs"
                  placeholder="Enter your password"
                  autoComplete="current-password"
                />
                <Lock className="w-3.5 h-3.5 text-slate-400 absolute left-2.5 sm:left-3 top-1/2 -translate-y-1/2" />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between pt-0.5">
              <label className="flex items-center gap-1.5 cursor-pointer">
                ...
                />
                <span className="text-[10px] sm:text-[11px] font-medium text-slate-600 hover:text-slate-900">
                  Remember me
                </span>
              </label>
              ...
              <Link
                to="/forgot-password"
                className="text-[10px] sm:text-[11px] font-semibold text-blue-600 hover:text-blue-700 hover:underline transition-colors"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <div className="pt-1.5 sm:pt-2 border-t border-slate-100 space-y-1">
              <p className="text-center text-[9px] sm:text-[10px] font-semibold text-slate-400 uppercase tracking-wider">
              ...
              <div className="grid grid-cols-2 gap-1.5">
                <Link
                  to="/register"
                  className="flex items-center justify-center gap-1 px-1.5 sm:px-2.5 py-1.5 rounded-lg bg-slate-50 hover:bg-blue-50/60 border border-slate-200/90 hover:border-blue-300 text-[10px] sm:text-[11px] font-bold text-slate-700 hover:text-blue-700 transition-all text-center group shadow-2xs"
                >
                ...
                <Link
                  ...
                  className="flex items-center justify-center gap-1 px-1.5 sm:px-2.5 py-1.5 rounded-lg bg-slate-50 hover:bg-emerald-50/60 border border-slate-200/90 hover:border-emerald-300 text-[10px] sm:text-[11px] font-bold text-slate-700 hover:text-emerald-700 transition-all text-center group shadow-2xs"
                >
            ...
            <div className="pt-0.5 text-center">
              <p className="text-[9px] sm:text-[10px] font-medium text-slate-400 tracking-wide">
