...
public class ExcelEmployeeRowDTO {
    ...
    public ExcelEmployeeRowDTO(int rowNumber, String employeeName, String telephone, String position,
                               String mealStatus, BigDecimal amountUsed, String status, String errorReason) {
    ...
    public static class ExcelEmployeeRowDTOBuilder {
        ...
        public ExcelEmployeeRowDTO build() {
            return new ExcelEmployeeRowDTO(rowNumber, employeeName, telephone, position, mealStatus, amountUsed, status, errorReason);
        }
    }
}
